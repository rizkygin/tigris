...
$url = substr($url,0,strpos($url,"filemanager"));
// print_r($url.'<br>');
...
$config = array(
    ...
    *******************/
    ...
    // Remember than the image creation respect the folder hierarchy so if you are inside uploads/test/test1/ the new image will create at
    ...
    */
    ...
    // The image creation path is always relative so if i'm inside uploads/test/test1 and I upload an image, the path start from here
    //
