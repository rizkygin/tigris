...
$(document).ready(function()
{
	...
	*/
	...
	function initColor()
	{
		// console.log($('.product_color').length);
	...
	function initVariant()
	{
		...
		{
			var selectedVariant = $('#selected_variant');
			var variantItems = $('.variant_list li .variant_mark');
			variantItems.each(function()
			{
				var variantItem = $(this);
				variantItem.on('click', function()
				{
					var variant = variantItem.text();
					var variantId = variantItem.data('variant-id');
					selectedVariant.text(variant);
					selectedVariant.attr('data-variant-id-selected', variantId);
				});
			});
		}
	}
