...
class Ajax_pagination_gal{
	...
	function create_links(){
		...
		?>
        <script>
        function getData_gal(){  

        	var page = $('#pageGAL').val();
            $.ajax({
                method: "POST",
                ...
                success: function(data){
                	...
                	$( "#postGAL" ).slideUp( "slow", function() {
                		$('<?php echo $this->target; ?>').html(data);
                	});
                    
                    $( "#postGAL" ).slideDown( "slow" );
	...
	function loadLink_gal($page){
		return '<input type="hidden" value="'.$page.'" name="pageGAL" id="pageGAL">';
