...
class Ajax_paginationx{
	...
	function create_links(){
		...
		if ($this->cur_page < $num_pages) {
			$output .= $this->loadLink($this->cur_page * $this->per_page);
		}else{
			$output .= $this->loadLink(0);
		}
        ...
        function getData(){  
            ...
            $.ajax({
                ...
                success: function(data){
                	...
                	$( "#postPST" ).slideUp( "slow", function() {
                		$('<?php echo $this->target; ?>').html(data);
                	});
                    
                    $( "#postPST" ).slideDown( "slow" );
	...
	function loadLink($page){
		return '<input type="hidden" value="'.$page.'" name="page" id="page">';
