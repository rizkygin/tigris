  ...
  <body class="skin-blue layout-top-nav">
    ...
    <!-- login-instansi -->
          ...
          ?>
              ...
              Form Pendaftaran Akun<br>
              <span>Mahasiswa</span>
            </div>
        
            <div class="login-box-body">
            <?php echo form_open('/Daftar_mahasiswa/simpan_data', array('name' => 'login_form '))?>
          ...
          ?>    
              ...
              <div class="form-group has-feedback">
                <labe>Nama Lengkap</labe>
                  <?php echo form_input('nama',@$dt->nama,'class="form-control" id="nama"')?>
              </div>
              ...
              <div class="form-group has-feedback">
                <labe>Program Konsentrasi</labe>
                  <?php echo form_dropdown('id_ref_program_konsentrasi', $cb_tipe,@$dt->id_ref_program_konsentrasi,'class="form-control combo-box" style="width: 100%"')?>
              </div>
        <!-- IF CAPTCHA -->
          <?php
        ...
        <!-- ./CAPTCHA -->
                ...
                <div class="form-group has-feedback visible-lg visible-md visible-sm">
                  ...
                  <button href="#" class="btn btn-primary btn-md btn-flat pull-left"><i class="fa fa-save"></i> &nbsp; Simpan</button>
