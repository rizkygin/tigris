  ...
  <div class="col-md-12">
    <div class="box box-warning">
      <div class="box-header with-border">
        ...
        <h3 class="box-title" id="form-title"> Import Data Untuk Dosen</h3>
      </div>
      <div class="box-body">
        <div id="form-content">
          <div class="row">
            ...
            <div class="col-lg-6">
              <label>Contoh Format</label>
                <img src="<?php echo base_url().'assets/images/data_dosen.png'?>" alt="contoh format" style="width:100%; height:100%">
            </div>
          </div>
