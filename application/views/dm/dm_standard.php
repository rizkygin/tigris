<?php if (!empty($css_load))echo $css_load;?>
<style  type="text/css">
<!--
.blink_me {
...
<div class="<?php echo $box_cls ?>" id="box-main">
    ...
    <div class="box-header with-border">
	    <div class="row">
			<div class="col-md-6"><?php echo @$tombol.@$tombol_tambah?></div>
			<?php if (!empty($extra_tombol)) echo '<div class="col-md-6">'.$extra_tombol.'</div>'; ?>
	    </div>
    </div><!-- /.box-header -->
    <?php } ?>
