	...
	<div class="box-body">
		<div class="col-lg-12">
			<div class="col-lg-5">
				...
				<p>
					<?php echo 
					form_hidden('keys[]','height_agenda_2').'<div class="input-group">'.
					form_input('vals[]',!empty($vals['height_agenda_2'])?$vals['height_agenda_2']:null,'
			...
			<div class="col-lg-4">		
				...
				<p><?php echo 
					form_hidden('keys[]','height_kalender_2').'<div class="input-group">'.
					form_input('vals[]',!empty($vals['height_kalender_2'])?$vals['height_kalender_2']:null,'
			...
			<div class="col-lg-3">		
				...
				<p><?php echo 
					form_hidden('keys[]','height_pengumuman_2').'<div class="input-group">'.
					form_input('vals[]',!empty($vals['height_pengumuman_2'])?$vals['height_pengumuman_2']:null,'
		...
		<div class="col-lg-12">
			...
			<div class="col-lg-4">		
				...
				<p><?php echo 
					form_hidden('keys[]','height_agenda_bulan_ini_2').'<div class="input-group">'.
					form_input('vals[]',!empty($vals['height_agenda_bulan_ini_2'])?$vals['height_agenda_bulan_ini_2']:null,'
			...
			<div class="col-lg-3">		
				...
				<p><?php echo 
					form_hidden('keys[]','height_galeri_2').'<div class="input-group">'.
					form_input('vals[]',!empty($vals['height_galeri_2'])?$vals['height_galeri_2']:null,'
		...
		<div class="col-lg-12">
			...
			<div class="col-lg-4">		
				...
				<p><?php echo 
					form_hidden('keys[]','height_agenda_bulan_depan_2').'<div class="input-group">'.
					form_input('vals[]',!empty($vals['height_agenda_bulan_depan_2'])?$vals['height_agenda_bulan_depan_2']:null,'
