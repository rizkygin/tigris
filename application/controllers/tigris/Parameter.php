...
class Parameter extends CI_Controller {
	...
	function paging() {
		...
		$data['breadcrumb'] = array('' => 'Pengaturan', $this->dir.'/Parameter' => 'Parameter');
		...
		$tab1 = array('text'=>'IDS', 'on'=>1, 'url'=>site_url($this->dir.'/Parameter/paging/'));/*
		$tab2 = array('text'=>'2 Kolom', 'on'=>NULL, 'url'=>site_url($this->dir.'/Parameter/dua_kolom/'));
		$tab3 = array('text'=>'3 Kolom', 'on'=>NULL, 'url'=>site_url($this->dir.'/Parameter/tiga_kolom/'));*/
		$data['title'] 		= $title;
		$data['tabs'] = array($tab1);
		$data['content'] = $this->dir.'/parameter_view';
	...
	function dua_kolom() {
		...
		$title = 'Pengaturan Layout';
		$tab1 = array('text'=>'Umum', 'on'=>NULL, 'url'=>site_url($this->dir.'/Parameter/paging/'));
		$tab2 = array('text'=>'2 Kolom', 'on'=>1, 'url'=>site_url($this->dir.'/Parameter/dua_kolom/'));
		$tab3 = array('text'=>'3 Kolom', 'on'=>NULL, 'url'=>site_url($this->dir.'/Parameter/tiga_kolom/'));
		$data['title'] 		= $title;
		$data['tabs'] = array($tab1, $tab2,$tab3);
		$data['content'] = $this->dir.'/Parameter_dua_kolom';
		$this->load->view('home',$data);
	...
	function tiga_kolom() {
		...
		$tab1 = array('text'=>'Umum', 'on'=>NULL, 'url'=>site_url($this->dir.'/Parameter/paging/'));
		$tab2 = array('text'=>'2 Kolom', 'on'=>NULL, 'url'=>site_url($this->dir.'/Parameter/dua_kolom/'));
		$tab3 = array('text'=>'3 Kolom', 'on'=>1, 'url'=>site_url($this->dir.'/Parameter/tiga_kolom/'));
		$data['title'] 		= $title;
		$data['tabs'] = array($tab1, $tab2,$tab3);
		$data['content'] = $this->dir.'/Parameter_tiga_kolom';
		$this->load->view('home',$data);
