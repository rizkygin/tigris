...
class Penjadwalan_tesis extends CI_Controller {
	...
	public function list_data($search=NULL, $offset=NULL) {
		...
		$dtjnsoutput = $this->general_model->datagrabs(array('tabel'=>$from, 'order'=>'id_tesis ASC', 'limit'=>$lim, 'offset'=>$offs, 'search'=>$fcari, 'select'=>$select,'where'=>$where));
...
die();*/
    ...
    // Line break
        ...
        $pdf->SetX(25);
         $pdf->Image(base_url()."assets/images/corp/ba-tesis.png",10,40,180,0);
...
');
        ...
        $pdf->SetTextColor(0,0,0);
        $pdf->SetX(140);
        $pdf->Cell(20,5,'Ketua Program Studi MIH');
        ...
        $pdf->SetTextColor(0,0,0);
        $pdf->SetX(140);
        $pdf->Cell(20,5,'Dr. Joko Setiyono, S.H., M.Hum');
        ...
        $pdf->SetTextColor(0,0,0);
        $pdf->SetX(140);
        $pdf->Cell(20,5,'NIP. 19660607 199203 1 001');
...
//penguji
        ...
        $pdf->Image(base_url()."assets/images/corp/lampiran_tesis.png",20,NULL,180,0);
...
');
        ...
        ;
				...
				$nox++;
			        ...
			        $pdf->SetX(59);
			        // $pdf->Image(base_url()."assets/images/corp/beritalogo.png",60,40,100,0);
			        $pdf->Image(base_url()."assets/images/corp/panitia-sidang-tesis.png",20,NULL,180,0);
        ...
        $pdf->SetTextColor(0,0,0);
        $pdf->SetX(135);
        $pdf->Cell(20,5,'Semarang, '.tanggal_indo(date("Y-m-d")).'');
