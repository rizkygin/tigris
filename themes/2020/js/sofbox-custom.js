...
(function(jQuery) {
    ...
    slideInitial();
        ...
        jQuery(this).find('.circle.purple-hover').circleProgress({fill: {
                color: '#6f73f0'
            }});
        jQuery(this).find('.circle.org-hover').circleProgress({fill: {
                color: '#ff796d'
            }});
        jQuery(this).find('.circle.green-hover').circleProgress({fill: {
                color: '#33e2a0'
            }});
        }
        });
        ...
        Pricing
        ---------------------------*/
        jQuery(".input-range").on("input change",function(){
